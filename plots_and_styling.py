...
external_scripts = [{
        ...
        'src': '//s7.addthis.com/js/300/addthis_widget.js#pubid=ra-5ea5bc0a83ef9c47',
    }]
...
##############################################################################################################################
# Moving Nigeria to the first row in the datatable (You can choose any country of interest to be display on the first row)
##############################################################################################################################

def df_move1st_sg(df_t):

    #Moving Nigeria to the first row in the datatable
    df_t["new"] = range(1,len(df_t)+1)
    df_t.loc[df_t[df_t['Country/Region'] == 'Nigeria'].index.values,'new'] = 0
...
map_data.loc[map_data[map_data['Country/Region'] == 'Nigeria'].index.values,'new'] = 0
...
#############################################################################
mapbox_access_token = 'pk.eyJ1Ijoid2FsZW9wYWt1bmxlIiwiYSI6ImNrOWg5dGxsMjBhcDEzZ213eTY2bm9xangifQ.Pm9M8IPxYIs55p4oloCxiA'
        ...
        html.Div([
            ...
            html.Div(
                    [
                        ...
                        html.A('Github',
                               href='https://github.com/CaduceusInc/covid19_tracker'),
                        html.P(' 2020.',
                            style={'display': 'inline'}),
                        html.Hr(),
                    ], className="twelve columns",
